...
namespace QA1_SYSTEM.Migrations
{
    ...
    [Migration("20231130011918_equipmentAddhistoryAssets")]
    partial class equipmentAddhistoryAssets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QA1_SYSTEM.Models.EquipmentMachineHistory", b =>
                {
                    ...
                    b.Property<int>("equipmentMachineEQPid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("equipmentMachineEQPid");
            ...
            modelBuilder.Entity("QA1_SYSTEM.Models.EquipmentMachineHistory", b =>
                {
                    b.HasOne("QA1_SYSTEM.Models.EquipmentMachine", "equipmentMachine")
                        ...
                        .HasForeignKey("equipmentMachineEQPid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
